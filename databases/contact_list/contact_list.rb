...
def make_contact_favorite(db, first_name)
  db.execute("UPDATE contacts SET favorite = 'Favorite' WHERE first_name=(?)", [first_name])
  puts "#{first_name} has been added to your favorites"
end
...
make_contact_favorite(db, 'Ruthe')
